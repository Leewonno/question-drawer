...
Claude / ChatGPT / Kimi / Gemini / DeepSeek 답변을 읽다 보면 "이건 나중에 따로 물어봐야지" 싶은 단어들이 계속 쌓입니다. 하지만 새로 질문을 하다 보면, 정작 물어보려던 것들을 까먹기 쉽습니다.
...
- URL의 대화 ID(`claude.ai/chat/<id>`, `chatgpt.com/c/<id>`, `kimi.com/chat/<id>`, `gemini.google.com/app/<id>`, `chat.deepseek.com/a/chat/s/<id>`)를 기준으로 질문을 저장
